...
appId = 4576   # 软件ＩＤ，开发者分成必要参数。登录开发者后台【我的软件】获得！
appKey = 'e94a4fc4ae4dd0a0c7a0668440cfe7e7'     # 软件密钥，开发者分成必要参数。登录开发者后台【我的软件】获得！
...
# 验证码文件路径
filename = '/Volumes/project/test_project/boss/boss/image_'
